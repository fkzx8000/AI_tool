...
class Sprint_2_Tests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.var1 = "Just"
        self.var2 = "Adding"
        self.var3 = "Complexity"
        self.var4 = self.var1 + self.var2 + self.var3

    # בדיקה של התחברות עם פרטים נכונים
    def test_tl_access_denied(self):
        self.assertEqual(self.var4, "JustAddingComplexity")
